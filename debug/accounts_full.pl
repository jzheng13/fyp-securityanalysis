...
hasAccount(imperial, "cp9914", imperial1).
hasAccount(disqus, "crazyp2017@gmail.com", disqus1).
hasAccount(github, "crazyp2017@gmail.com", github1).
hasAccount(baidu, "crazyp2017@gmail.com", baidu1).
...
accountLogin(imperial1, "cp9914", "1CPpffICL33?").
accountLogin(disqus1, "crazyp2017@gmail.com", "IdqwevI1t.").
accountLogin(github1, "crazyp2017@gmail.com", "1CPpffICL33?").
accountLogin(baidu1, "crazyp2017@gmail.com", "TimBDpwf119!").
...
singleSignOn(overleaf1, google2).
...
accountEmail(overleaf1, google2, private).
accountEmail(disqus1, google2, private).
accountEmail(github1, imperial1, private).
accountEmail(baidu1, google2, private).
...
publicInfo(goal1, []).
publicInfo(overleaf1, []).
publicInfo(baidu1, []).
publicInfo(imperial1, []).
publicInfo(disqus1, []).
publicInfo(github1, []).
...
privateInfo(imperial1, [name, birthday, address]).
privateInfo(overleaf1, [name, university]).
privateInfo(disqus1, []).
privateInfo(baidu1, [name, birthday, location, mobile]).
...
resetInfo(overleaf1, [email], google2).
resetInfo(baidu1, [email], google2).
resetInfo(github1, [email], imperial1).
resetInfo(imperial1, [username, cid, birthday, mobile], default).
resetInfo(disqus1, [email], google2).
